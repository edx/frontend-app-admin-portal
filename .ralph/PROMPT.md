...
- run the linters with and fix any lint errors after tests are passing
...
## Build & Run
See AGENT.md for build and run instructions, but frequently I'll already have the app running
