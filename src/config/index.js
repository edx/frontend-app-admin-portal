...
const configuration = {
  ...
  ENTERPRISE_ADMIN_ROLES_SURVEY_URL: process.env.ENTERPRISE_ADMIN_ROLES_SURVEY_URL,
  ADMIN_ONBOARDING_UUIDS: {
    FLOW_TRACK_LEARNER_PROGRESS_UUID: process.env.FLOW_TRACK_LEARNER_PROGRESS_UUID,
    FLOW_ANALYTICS_UUID: process.env.FLOW_ANALYTICS_UUID,
    FLOW_ORGANIZE_LEARNERS_UUID: process.env.FLOW_ORGANIZE_LEARNERS_UUID,
    FLOW_ENROLLMENT_INSIGHTS: process.env.FLOW_ENROLLMENT_INSIGHTS,
    FLOW_SHOWCASE_COURSES_UUID: process.env.FLOW_SHOWCASE_COURSES_UUID,
    FLOW_PREFERENCES_UUID: process.env.FLOW_PREFERENCES_UUID,
    FLOW_CUSTOMIZE_REPORTS_UUID: process.env.FLOW_CUSTOMIZE_REPORTS_UUID,
