...
export const LEARNER_CREDIT_MANAGEMENT_EVENTS = {
  ...
  // Activity tab pending (approved requests) table bulk remind
  BUDGET_DETAILS_PENDING_DATATABLE_OPEN_BULK_REMIND_MODAL: `${BUDGET_DETAIL_ACTIVITY_TAB_PREFIX}.pending_table_bulk_remind_modal_open.clicked`,
  BUDGET_DETAILS_PENDING_DATATABLE_CLOSE_BULK_REMIND_MODAL: `${BUDGET_DETAIL_ACTIVITY_TAB_PREFIX}.pending_table_bulk_remind_modal_close.clicked`,
  BUDGET_DETAILS_PENDING_DATATABLE_BULK_REMIND: `${BUDGET_DETAIL_ACTIVITY_TAB_PREFIX}.pending_table_bulk_remind.clicked`,
  // Activity tab chips
