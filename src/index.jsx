  ...
  handlers: {
    config: () => {
      mergeConfig({
        ...
        MAX_STARRED_CONTENT_ITEMS_PER_HIGHLIGHT_SET: process.env.MAX_STARRED_CONTENT_ITEMS_PER_HIGHLIGHT_SET || null,
        ...
        DISABLE_COURSE_PROGRESS_COLUMN_FOR_ENTERPRISE_CUSTOMER:
          process.env.DISABLE_COURSE_PROGRESS_COLUMN_FOR_ENTERPRISE_CUSTOMER || null,
      });
    },
  },
  messages,
